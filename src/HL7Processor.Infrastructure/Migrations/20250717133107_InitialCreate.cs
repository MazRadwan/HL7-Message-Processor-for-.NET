        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalTimestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Segments_Messages_MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_Segments_SegmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fields_SegmentId",
                table: "Fields",
                column: "SegmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Segments_MessageId",
                table: "Segments",
                column: "MessageId");
        }
